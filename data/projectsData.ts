const projectsData = [
  ...
  },
  {
    ...
    description: `A script that parses .md files within "input" directory and prints out an array of broken URLs that were found.
    [TypeScript, Node JS]`,
    imgSrc: '/static/images/internal-link-checker-logo-large.png',
